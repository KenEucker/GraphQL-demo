...
export type AuthorSubscriptionPayloadKeySpecifier = (
  | 'data'
  | 'mutation'
  | AuthorSubscriptionPayloadKeySpecifier
)[]
export type AuthorSubscriptionPayloadFieldPolicy = {
  data?: FieldPolicy<any> | FieldReadFunction<any>
  mutation?: FieldPolicy<any> | FieldReadFunction<any>
}
export type InteractionKeySpecifier = (
  | 'author'
  | 'id'
  | 'like'
  | 'post'
...
export type InteractionSubscriptionPayloadKeySpecifier = (
  | 'data'
  | 'mutation'
  | InteractionSubscriptionPayloadKeySpecifier
)[]
...
export type PostSubscriptionPayloadKeySpecifier = (
  | 'data'
  | 'mutation'
  | PostSubscriptionPayloadKeySpecifier
)[]
...
export type StrictTypedTypePolicies = {
  ...
  AuthorSubscriptionPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | AuthorSubscriptionPayloadKeySpecifier
      | (() => undefined | AuthorSubscriptionPayloadKeySpecifier)
  ...
  InteractionSubscriptionPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | InteractionSubscriptionPayloadKeySpecifier
      | (() => undefined | InteractionSubscriptionPayloadKeySpecifier)
  ...
  PostSubscriptionPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PostSubscriptionPayloadKeySpecifier
      | (() => undefined | PostSubscriptionPayloadKeySpecifier)
